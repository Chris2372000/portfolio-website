          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hello, I’m Siani Christian, a software engineer focused on building scalable and high-performance
                web applications using React, Next.js, and TypeScript.
                I care about clean architecture and great user experiences.
              </p>
            </div>
